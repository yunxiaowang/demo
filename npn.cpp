...
//        {
//            printf("[NPN] NPN_Invoke NPP:%s, NPObject:0x%x, methodname:%s, argcount:%d\n",
//                pFlash->objectId.c_str(),obj,static_cast<Identifier *>(methodname)->getString(),argcount);
//        }
//    }
//    else
//    {
...
//            if(Identifier::get("toString") != methodname)
//            {
//                printf("[NPN] NPN_Invoke NPP:%s, methodname:%s, argcount:%d\n",
//                    pFlash->objectId.c_str(),static_cast<Identifier *>(methodname)->getString(),argcount);
//            }
//            if(argcount > 0)
//            {
//                printf("%s arguments:\n",static_cast<Identifier *>(methodname)->getString());
//                for(int i = 0;i < argcount;i++)
//                {
//                    if(args[i].type == NPVariantType_String)
//                    {
//                        printf(">argument %d: type:string %s\n",i,args[i].value.stringValue.UTF8Characters);
//                    }
//                    else if(args[i].type == NPVariantType_Int32)
//                    {
//                        printf(">argument %d: type:int %d\n",i,args[i].value.intValue);
//                    }
//                    else if(args[i].type == NPVariantType_Null)
//                    {
//                        printf(">argument %d: type:NULL\n",i);
//                    }
//                    else if(args[i].type == NPVariantType_Object)
//                    {
//                        printf(">argument %d: type:object %s\n",i,args[i].value.stringValue.UTF8Characters);
//                    }
//                    else
//                    {
...
//void xml2NPVariant(std::string xmlstr, NPVariant * pResult)
//{
//    if(xmlstr == "<undefined/>")
//    {
//        VOID_TO_NPVARIANT(*pResult);
//        printf("xml2NPVariant:void\n");
//    }

//    if(xmlstr.substr(0,8) == "<string>")
//    {
//        const char * str = faststrdup(xmlstr.substr(8,xmlstr.length() - 17).c_str());

//        STRINGZ_TO_NPVARIANT(faststrdup(xmlstr.substr(8,xmlstr.length() - 17).c_str()),*pResult);

//        printf("xml2NPVariant:%s\n",str);
//    }

//    if(xmlstr.substr(0,8) == "<number>")
//    {
//        std::string strNumber = xmlstr.substr(8,xmlstr.length() - 17);
//        int Num = atoi(strNumber.c_str());
//        INT32_TO_NPVARIANT(Num,*pResult);
//        printf("xml2NPVariant:%d\n",Num);
//    }
...
//bool getJSResultVariant(std::string jsCode, NPVariant * jsRes)
//{
//    if(jsRes == NULL)
//    {
//        printf("result pointer error!!!\n");
//        return false;
//    }

//    int len1 = strlen("var __flash_temp = ");
//    int len2 = strlen("; __flash_temp;\n");
//    std::string tmpstr = jsCode.substr(len1,jsCode.length() - len1 - len2);
//    printf("getJSResultVariant tmpstr: %s\n",tmpstr.c_str());
//    if(tmpstr == "null" || tmpstr == "NULL")
//    {
//        NULL_TO_NPVARIANT(*jsRes);
//        printf("js result: null\n");
//        return true;
//    }
//    if(tmpstr == "true")
//    {
//        BOOLEAN_TO_NPVARIANT(true,*jsRes);
//        printf("js result: true\n");
//        return true;
//    }
//    if(tmpstr == "false")
//    {
//        BOOLEAN_TO_NPVARIANT(false,*jsRes);
//        printf("js result: false\n");
//        return true;
//    }
//    if(tmpstr[0] == '"')
//    {
//        tmpstr = tmpstr.substr(1,tmpstr.length() - 2);
//        STRINGN_TO_NPVARIANT(faststrdup(tmpstr.c_str()),tmpstr.length(),*jsRes);
//        printf("js result: string %s\n",jsRes->value.stringValue.UTF8Characters);
//        return true;
//    }
...
//        {
//            double dbVal = atof(tmpstr.c_str());
//            DOUBLE_TO_NPVARIANT(dbVal,*jsRes);
//            printf("js result: double %lf\n",jsRes->value.doubleValue);
//        }
//        else
//        {
//            int inVal = atoi(tmpstr.c_str());
//            INT32_TO_NPVARIANT(inVal,*jsRes);
//            printf("js result: int %d\n",jsRes->value.intValue);
//        }
//        return true;
//    }
//    return false;
